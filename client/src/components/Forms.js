  ...
  return (
    <div className="mt-20">
        <form className="max-w-lg mx-auto">
            <h1 className="font-semibold text-lg mb-5">Add new connections</h1>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <label for="floating_first_name" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Connect For?</label>
                </div>
                <div class="relative z-0 w-full mb-5 group">
            ...
            <button className="active:scale-[.98] active:duration-75 hover:scale-[1.02] ease-in-out transition-all py-3 rounded bg-green-500 text-white text-sm font-bold p-3">Add</button>
        </form>
    </div>
  )
}
