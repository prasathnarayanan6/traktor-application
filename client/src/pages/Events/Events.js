                                        ...
                                        <div className="grid grid-cols-2 gap-5 px-10">
                                                ...
                                                <div className="cols-span-3">
                                                        <div className="grid grid-cols-3 gap-4">
                                                                ...
                                                                <div><button className="text-gray-500 text-sm font-semibold mt-1 p-1 px-3 rounded-xl shadow-md"  style={{backgroundColor: '#afd5de'}}>Create Event</button></div>
                                                                <div><button className="text-gray-500 text-sm font-semibold mt-1 p-1 px-3 rounded-xl shadow-md"  style={{backgroundColor: '#afcdde'}}>Request Speaker</button></div>
                                                        </div>
                                                </div>
                                        </div>
